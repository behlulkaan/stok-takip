...
include "../assets/css_js_connect.php";
 ...
 <html>
<head>
	<title>Stok Yönetimi - Stok Takip Sistemi</title>
</head>
<body>
	<nav style="background: #2a2c30" class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav">
				<li class="nav-item ">
					<a class="nav-link aktif" href="../stok">Stok Bilgisi <span style="margin-top: 5px;float: right;display: block;margin-left: 5px"> <ion-icon name="cube-outline"></ion-icon></span></a></span></a>
				</li>
				<li class="nav-item ">
